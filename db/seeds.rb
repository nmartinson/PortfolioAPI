...
#   puts item
#   gallery = Gallery.create(name: item, description: 'Gallery Description', cover_image: "http://localhost:3000/assets/Galleries/Olympic/DSC_6485-347f5ed8bac3ab0620cf81bf1486712a745c2a2d650dbe95c9b84d444bd5a7e3.jpg", cover_is_landscape: true)
#   Dir.foreach("app/assets/images/Galleries/" + item) do |innerItem|
#   	next if ['.', '..', '.DS_Store'].include?(innerItem)
# 	photo = Photo.create(name: "Image Name", description: "Image Description", url: "http://localhost:3000/assets/Galleries/" + item + "/" + innerItem, gallery_id: gallery.id)
